...
,document_number',
        ...
        $supplier = Supplier::create($data);
         ...
         session()->flash('swal',[
            'icon' => 'success',
            'title' => 'Bien hecho!',
            'text' => 'El proveedor se ha creado con exito'
         ]);
    ...
    public function destroy(Supplier $supplier)
    {
        ...
        if($supplier->purchaseOrders()->exists() || $supplier->purchases()->exists()){
            session()->flash('swal', [
                'icon' => 'error',
                'title' => 'Error',
                'text' => 'No se puede eliminar el proveedor porque tiene ordenes de compra o ventas asociadas'
            ]);
        ...
        session()->flash('swal', [
            'icon' => 'success',
            'title' => 'Bien hecho!',
            'text' => 'El proveedor se ha eliminado con exito'
        ]);
        return redirect()->route('admin.suppliers.index');
    }
}

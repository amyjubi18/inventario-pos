<div x-data="{
    ...
    <x-wire-card class="dark:bg-gray-700">
        <form wire:submit="save" class="space-y-4" wire:loading.attr="disabled" wire:target="save, addProduct">
            <div wire:loading wire:target="save, addProduct" class="mb-2 font-semibold text-center text-blue-600">
                Procesando...
            </div>
